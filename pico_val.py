    ...
    def eval(self, opt, seq_paths, save_dir, MOT_results_folder, val_tools_path, gt_folder, free_devices):
        ...
        if not self.opt.eval_existing:
            ...
            for i, seq_path in enumerate(seq_paths):
                ...
                p = subprocess.Popen(
                    args=[
                        sys.executable, ROOT / 'pico_track.py',
                        "--demo", self.opt.demo,
...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default= 'picodet_s_320_coco_lcnet.yml', help='config name')
    ...
    parser.add_argument('--benchmark', type=str, default='MOT16',
